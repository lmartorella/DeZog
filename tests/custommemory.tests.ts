...
suite('CustomMemory', () => {
	test('ROM load', () => {
		...
		assert.equal(0x02, mem.getMemory8(0x0002));
		assert.equal(0xFF, mem.getMemory8(0x3FFF));

		assert.equal(0x00, mem.getMemory8(0x4000));
		assert.equal(0x00, mem.getMemory8(0x4001));

		assert.equal(0x00, mem.getMemory8(0x7FFF));
		assert.equal(0x00, mem.getMemory8(0x8000));
		assert.equal(0x00, mem.getMemory8(0x8001));
		assert.equal(0x00, mem.getMemory8(0xBFFF));

		assert.equal(0xff, mem.getMemory8(0xC000));
		assert.equal(0xff, mem.getMemory8(0xFFFF));

		const memoryModel = mem.getMemoryModel();
